...
const musicData = [
  {
    ...
    year: '2025',
    lyricsUrl: process.env.PUBLIC_URL + '/lyrics/banwag.txt',
  ...
  },
  {
    ...
    year: '2024',
    lyricsUrl: process.env.PUBLIC_URL + '/lyrics/ngalan.txt',
  ...
  },
  {
    ...
    writer: 'Duane Dell Fuderenan • John Milo Atibula',
    year: '2024',
    lyricsUrl: process.env.PUBLIC_URL + '/lyrics/gitagbo.txt',
  ...
  },
  {
    ...
    year: '2024',
    lyricsUrl: process.env.PUBLIC_URL + '/lyrics/taliwala.txt',
    ...
    tracks: [
        {
            ...
            year: '2024',
            lyricsUrl: process.env.PUBLIC_URL + '/lyrics/bundak_ulan.txt',
        ...
        },
        {
            ...
            year: '2024',
            lyricsUrl: process.env.PUBLIC_URL + '/lyrics/bantugan.txt',
        ...
        },
        {
            ...
            year: '2024',
            lyricsUrl: process.env.PUBLIC_URL + '/lyrics/no_longer_i.txt',
        ...
        },
        {
            ...
            year: '2024',
            lyricsUrl: process.env.PUBLIC_URL + '/lyrics/pagkagamhanan.txt',
